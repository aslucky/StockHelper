...
class strategy():
    ...
    def macdCross(self, klines):
        ...
        '''
        # macd diff上穿dea
        if analysis.empty and analysis.iloc[len(analysis) - 1, 0] > analysis.iloc[len(analysis) - 1, 1] and analysis.iloc[len(analysis) - 2, 0] < analysis.iloc[
                    len(analysis) - 2, 1]:
            return True
        return False

    def macdDivergence(self):
        pass
